...
$cesar = new Cibo("Cesar", 3, $categoria_cane, "https://arcaplanet.vtexassets.com/arquivos/ids/256506-1800-1800/cesar-ricette-di-campagna-pollo-verdure.jpg?v=1770838122&quality=1&width=1800&height=1800", "2022-10-10");

$prova = new Prodotto("", 7, $categoria_cane, "");

try {
    $prova->setNome("");
} catch(Exception $err) {
    echo 'Attenzione: ' . $err->getMessage();
}
